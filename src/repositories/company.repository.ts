...
> {
  ...
  public readonly bankAccount: HasOneRepositoryFactory<
    BankAccount,
    typeof Company.prototype.id
  >;

  public readonly serviceProviders: HasManyRepositoryFactory<
    ServiceProvider,
    typeof Company.prototype.id
  >;
  ...
  constructor(
    ...
    this.serviceProviders = this.createHasManyRepositoryFactoryFor(
      'serviceProviders',
      serviceProviderRepositoryGetter,
    );
    this.registerInclusionResolver(
      'serviceProviders',
      this.serviceProviders.inclusionResolver,
    );
    this.bankAccount = this.createHasOneRepositoryFactoryFor(
      'bankAccount',
      bankAccountRepositoryGetter,
    );
    this.registerInclusionResolver(
      'bankAccount',
      this.bankAccount.inclusionResolver,
    );
