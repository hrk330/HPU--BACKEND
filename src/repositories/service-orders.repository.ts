...
> {
  ...
  public readonly crashReport: HasOneRepositoryFactory<CrashReports, typeof ServiceOrders.prototype.serviceOrderId>;

  constructor(
    @inject('datasources.MongoDb') dataSource: MongoDbDataSource, @repository.getter('ServicesRepository') protected servicesRepositoryGetter: Getter<ServicesRepository>, @repository.getter('CrashReportsRepository') protected crashReportsRepositoryGetter: Getter<CrashReportsRepository>,
  ) {
