...
exports.AppUsersAccountController = void 0;
const tslib_1 = require("tslib");
const repository_1 = require("@loopback/repository");
const rest_1 = require("@loopback/rest");
const models_1 = require("../models");
const repositories_1 = require("../repositories");
let AppUsersAccountController = class AppUsersAccountController {
...
tslib_1.__decorate([
    (0, rest_1.get)('/app-users/{id}/account', {
        responses: {
            '200': {
...
], AppUsersAccountController.prototype, "get", null);
tslib_1.__decorate([
    (0, rest_1.post)('/app-users/{id}/account', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], AppUsersAccountController.prototype, "create", null);
tslib_1.__decorate([
    (0, rest_1.patch)('/app-users/{id}/account', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], AppUsersAccountController.prototype, "patch", null);
tslib_1.__decorate([
    (0, rest_1.del)('/app-users/{id}/account', {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:paramtypes", [String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], AppUsersAccountController.prototype, "delete", null);
AppUsersAccountController = tslib_1.__decorate([
...
], AppUsersAccountController);
exports.AppUsersAccountController = AppUsersAccountController;
//# sourceMappingURL=app-users-account.controller.js.map