...
> {
  public readonly witnesses: HasManyRepositoryFactory<
    Witness,
    typeof CrashReports.prototype.crashReportId
  >;
  ...
  constructor(
    ...
    @repository.getter('WitnessRepository')
    protected witnessRepositoryGetter: Getter<WitnessRepository>,
  ) {
    super(CrashReports, dataSource);
    this.witnesses = this.createHasManyRepositoryFactoryFor(
      'witnesses',
      witnessRepositoryGetter,
    );
    this.registerInclusionResolver(
      'witnesses',
      this.witnesses.inclusionResolver,
    );
  }
}
